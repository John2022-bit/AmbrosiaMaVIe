...
<html lang="fr">
  ...
  <?php
    if (isset($_POST['mot_de_passe']) AND $_POST['mot_de_passe'] ==  "2345") // Si le mot de passe est bon
    {
     ...
     <div class="row align-items-center">
       ...
       <div class="col-md-6">
        <ol class="breadcrumb justify-content-md-end bg-transparent">  
          ...
          <li class="breadcrumb-item">
            <a href="verification_video.php"> Ajouter une vidéo</a>
          </li>
          <li class="breadcrumb-item">
            Formulaire Ajout
          </li>
    ...
    <div class="row">
      <div class="col-lg-9 mt-4">
       ...
       <div class="card shadow-v5 mt-5 padding-40">
          ...
          <p>
            Vous devez être inscrit pour ajouter un article. <a href="">s'inscrire</a>
          </p>
          <form action="insertionArticle.php" method="POST" enctype="multipart/form-data">
            ...
            <textarea class="form-control mb-4" rows="5" name="commentaire" placeholder="Votre article"></textarea>
